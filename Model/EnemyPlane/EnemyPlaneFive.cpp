...
void SpaceWar::EnemyPlaneFive::update(float dt)
{
	EnemyPlane::update(dt);
}

void SpaceWar::EnemyPlaneFive::onEnter()
{
	EnemyPlane::onEnter();
}

void SpaceWar::EnemyPlaneFive::onExit()
{
	//取消订阅的信息..
...
void SpaceWar::EnemyPlaneFive::cleanup()
{
	EnemyPlane::cleanup();

}

void SpaceWar::EnemyPlaneFive::activate()
{
	...
	schedule(CC_CALLBACK_0(EnemyPlaneFive::move, this),
		0.1,
		CC_REPEAT_FOREVER,
		0,
...
void SpaceWar::EnemyPlaneFive::shoot()
{
...
//
void SpaceWar::EnemyPlaneFive::move()
{
...
void SpaceWar::EnemyPlaneFive::manualDestroy(float time)
{
	//
...
SpaceWar::EnemyPlaneFive* SpaceWar::EnemyPlaneFive::clone()
{
	EnemyPlaneFive* plane = EnemyPlaneFive::create(this->m_filename);
...
void SpaceWar::EnemyPlaneFive::BeginContact(cocos2d::Vec2 contact, CPhysicsSprite* other)
{
...
void SpaceWar::EnemyPlaneFive::EndContact(cocos2d::Vec2 contact, CPhysicsSprite* other)
{
...
//
bool SpaceWar::EnemyPlaneFive::init()
{
	bool bRet = false;
	do
	{
		...
		this->setSprayingLeftPoint(Vec2(29, 33));
		this->setSprayingRightPoint(Vec2(54, 33));
		this->setShootingPoint(Vec2(41, 69));
		this->setMiddlePoint(Vec2(42, 35));
		this->setShootingLeftPoint(Vec2(21, 59));
		this->setShootingRightPoint(Vec2(60, 59));
		this->setHp(50);
		...
		schedule(CC_CALLBACK_0(EnemyPlaneFive::shoot, this),
			0.1f,
			CC_REPEAT_FOREVER,
			0,
...
void SpaceWar::EnemyPlaneFive::speak()
{
...
SpaceWar::EnemyPlaneFive::~EnemyPlaneFive()
{
...
SpaceWar::EnemyPlaneFive* SpaceWar::EnemyPlaneFive::create(const std::string& filename)
{
	EnemyPlaneFive *sprite = new (std::nothrow) EnemyPlaneFive();
